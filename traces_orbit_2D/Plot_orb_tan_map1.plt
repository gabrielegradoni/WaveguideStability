...
set ylabel "  y= {/Symbol q}/(2{/Symbol p}) " 
a=0.5
set xrange [-a:a]
set yrange [0:a]
#  set yrange [0:a]
...
#      set format y '10^{%L}'
       set nokey     
     plot FILE     u  2:4         w   points     pt  1   lc   rgb "blue"     ps  0.1   t    ' orbits   '    #  ,\
#    FILE1    u  2:4         w   points     pt  5   lc   rgb "red"      ps  .5   t    ' initial conditions '  